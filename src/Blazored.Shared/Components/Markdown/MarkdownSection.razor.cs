...
// https://github.com/microsoft/fluentui-blazor/blob/main/examples/Demo/Shared/Components/MarkdownSection.razor.cs
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            _jsModule = await JSRuntime.InvokeAsync<IJSObjectReference>("import",
                ...
                "./_content/Blazored.Shared/Components/Markdown/MarkdownSection.razor.js");
        }
